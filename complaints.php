...
<!------------------------------------------------------------->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3  align="center"><i class="fa fa-angle-right"></i>Check Screening Results</h3>
				<div class="row">    
                  <div class="col-md-12">
		...
		<th colspan=6></th>
		  <th colspan=12></th>
            <tr>
				...
				<th>Cough</th>
				<th>Changes in sense of taste</th>
                
				<th>In the past 2 weeks, have you been told that you have COVID-19?</th>
				<th>Are you waiting for a COVID-19 test result?</th>
				<th>Comment</th>
				<th>Action</th>
            </tr>
        </thead>
        <tbody>
		<?php 
									 		  $ret=mysqli_query($con,"select * from screening");
											  $cnt=1;
            ...
            <tr>
				...
				<td>|
				<a href="deleteComp.php?id=<?php echo $row['id'];?>" onClick= "return confirm('Do you really want to delete');">Delete
			     </a>
                 </td>
            </tr>
            <?php } ?>
